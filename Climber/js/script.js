  ...
  `;
    ...
    let flyEagle = setInterval(function () {
        ...
        let timer = setInterval(function () {
            ...
            if (eagleXM >= manX + manW / 3 && eagleXM <= manX + (2 * manW) / 3 && eagleYM >= manY && eagleYM <= manY + manH) {
                man.style.cssText = `
            width: 50%;
            top: 40%;
            transform: scale(1, -1);
          `;
                ...
                message.innerText = 'Упс, мужика увели!!';
                dialog.showModal();
            }
        }, 25);
    }, 5000);
    ...
    let flyEagle2 = setInterval(function () {
        ...
        let timer = setInterval(function () {
            ...
            if (eagle2XM >= manX + manW / 3 && eagle2XM <= manX + (2 * manW) / 3 && eagle2YM >= manY && eagle2YM <= manY + manH) {
                man.style.cssText = `
            width: 50%;
            top: 40%;
            transform: scale(1, -1);
    ...
    const timer3 = setTimeout(function () {
        ...
        let flyEagle3 = setInterval(function () {
            ...
            let timer = setInterval(function () {
                ...
                if (eagle3XM >= manX + manW / 3 && eagle3XM <= manX + (2 * manW) / 3 && eagle3YM >= manY - manH && eagle3YM <= manY + 2 * manH) {
                    man.style.cssText = `
              width: 25%;
              top: 45%;
              transform: scale(1, -1);
